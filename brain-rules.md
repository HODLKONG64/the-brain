...
# 100% of all conversation history, all previous brain-rules.md versions, all expansions, all storylines, all characters, all rules locked in.
...
## CORE IDENTITY & LORE STYLE (locked)
...
## ETERNAL CODEX FILE STORED ON THE WORLD CHAIN (28-section template locked)
...
## TELEGRAM USER INTERACTION RULES (locked)
...
## RANDOM DAILY MOMENTS (locked — expanded + seasonal + holiday variations)
...
## CRYPTO MOONBOYS 3 MEANINGS (locked)
...
## BLOCKTOPIA, HARDFORK GAMES, CROWNED ROYAL MOONGIRLS, BITCOIN X KIDS, OG BITCOIN KIDS (all expansions locked)
...
## IMAGE CONSISTENCY & CHARACTER BIBLE (locked)
...
This file contains 100% of every request made in the chat. The agent loads this file every run.

...
## LINKS THE AGENT MUST CHECK ONLY (locked from all versions)
...
## LADY-INK RULES (locked from all versions)
...
## CRYPTO MOONBOYS 3 MEANINGS (locked from all versions)
...
## IMAGE CONSISTENCY & CHARACTER BIBLE (locked from all versions)
